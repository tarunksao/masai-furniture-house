     ...
     return (
       ...
       <Box width="100%">{
          ...
          Products.map((prod)=>{
               ...
               <HStack>
                 <Img height="200px" width="150px" src={prod.image_src} alt="product image" />
                 <Box>
                   <Text marginBottom="8px" textAlign="left" fontSize="sm" fontWeight="bold">{prod.prod_desc}</Text>
                   <Text textAlign="left" fontSize="sm"><span >Category:</span> {prod.category}</Text>
                   <Text textAlign="left" fontSize="sm"><span >Brand:</span> {prod.brand_name}</Text>
                   ...
                   <HStack marginTop="7px">
                     ...
                     <Spacer /> */}
                     <Text textAlign="left" color="green"><span >Mrp:</span> ₹{prod.price}</Text>
                   </HStack>
                 </Box>
               </HStack>
